...
class Non_Govt extends StatefulWidget {
  const Non_Govt({super.key});

  @override
  State<Non_Govt> createState() => _Non_GovtState();
}

class _Non_GovtState extends State<Non_Govt> {

  List<dynamic>Posts=[];
  Future<void>dataFetch()async{
    final Api="https://raw.githubusercontent.com/riadrayhan/Job_Circular_BD/main/non_gov";
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
            children:List.generate(Posts.length, (index) {
              return Card(
                child: ExpansionTile(
                  title: Text("Non-Govement Jobs",style: TextStyle(fontWeight: FontWeight.bold),),
                  subtitle: Text("Find your dream job",style: TextStyle(fontSize: 12),),
                  leading: Icon(Icons.screen_search_desktop_outlined,color: Colors.green,),
                  children: [
                    Container(
